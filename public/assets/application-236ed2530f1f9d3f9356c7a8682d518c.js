...
(function() {
  ...
  $("#submit-player-search").on("click", function(event) {
    var name;
    event.preventDefault();
    ...
    return $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        ...
        return $.each(data, function(key, value) {
          var levelCell, nameCell, row, vocationCell, worldCell;
          row = $("<tr>");
          ...
          return $("table#search-results tbody").append(row);
        });
      }
    });
  });
